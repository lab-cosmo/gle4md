...
/* 4MR */
enum GLEFPointType { TauP2, TauQ2, TauH, KP2, KQ2, KH, Hw, Kw, HonK, DwQ, DwP, rDwQ, rDwP, LFP, PI2, PI10, PI100, RPImPole, CqqDT, CppDT, Cqq, Cpp, PTMin=TauP2, PTMax=Cpp+1 };
...
class GLEFParOptions
{
  public:
    unsigned long ns;
    double deltat; double rpomega; /* 4MR */
