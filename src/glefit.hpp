...
/* 4MR */
enum GLEFPointType { TauP2, TauQ2, TauH, KP2, KQ2, KH, Hw, Kw, HonK, DwQ, DwP, rDwQ, rDwP, LFP, PI2, PI10, PI100, RPImPole, RPRePole, RPReRes, CqqDT, CppDT, Cqq, Cpp, PTMin=TauP2, PTMax=Cpp+1 };
